...
Medical Database project involves creating a database for a clinic and their patients based on a given diagram.
...
```sh
  git clone https://github.com/Matthieu96Code/medical-database.git
  cd medical-database
```
...
Feel free to check the [issues page](https://github.com/Matthieu96Code/medical-database/issues).
...
I would like to thank microverse for providing us the ER Diagram.

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 📝 License <a name="license"></a>

This project is [MIT](https://github.com/Matthieu96Code/medical-database/blob/Dev/LICENSE) licensed.
